          ...
          <div className="rounded-3xl bg-layer p-8 h-full">
            <div className="rounded-3xl bg-block p-8 h-full flex flex-col justify-between">
              ...
              <div className="text-center">
                ...
                <button className="text-gray-600 font-thin bg-button hover:bg-layer hover:text-text custom-border duration-500 ease-in-out px-4 py-2 rounded-lg mt-3">Launch Dapp</button>
              </div>
